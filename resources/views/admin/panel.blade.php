...
{{--                                            </div>--}}
{{--                                            <div class="fw-bold fs-6 text-gray-400">Visit your Site from LcShop</div>--}}
{{--                                        </div>--}}
{{--                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3 text-center">--}}
{{--                                            <div class="d-flex justify-content-center align-items-center">--}}
{{--                                                <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="0">0</div>--}}
{{--                                            </div>--}}
{{--                                            <div class="fw-bold fs-6 text-gray-400">Products</div>--}}
{{--                                        </div>--}}
{{--                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3 text-center">--}}
{{--                                            <div class="d-flex justify-content-center align-items-center">--}}
{{--                                                <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="0" data-kt-countup-prefix="%">0</div>--}}
...
{{--                            <li class="nav-item">--}}
{{--                                <a class="nav-link {{ isUrl(route('panel')) }} text-active-primary me-6" href="{{ route('panel') }}">Overview</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a class="nav-link {{ isUrl(route('profile.setting')) }} text-active-primary me-6" href="{{ route('profile.setting') }}">Store information</a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </div>--}}
